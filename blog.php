...
<html lang="en">
    <head>
        ...
        <title>Home - Blog Lensa Kata</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="http://localhost/pemrograman%20web/blog.php">Lensa Kata</a>
        ...
        <header class="py-5 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">Selamat Datang di Blog Lensa Kata</h1>
                    <p class="lead mb-0">Artikel seputar Lifestyle, Drama, Teknologi, Sport/E-Sport, dan lainnya</p>
                </div>
            </div>
        </header>
        <!-- Page content-->
